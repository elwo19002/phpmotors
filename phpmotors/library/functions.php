...
function navigationPopulation($carclassifications) {
    $navList = '<ul>';
 ...
 function buildVehiclesDisplay($vehicles){
    ...
    foreach ($vehicles as $vehicle) {
     $dv .= '<li>';
     $dv .= "<a href='/phpmotors/vehicles/?action=carInfo&vehicleId={$vehicle["invId"]}'>";
     $dv .= "<img src='$vehicle[invThumbnail]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'>";
     $dv .= "</a>";
     $dv .= "<a href='/phpmotors/vehicles/?action=carInfo&vehicleId={$vehicle["invId"]}'><h2>$vehicle[invMake] $vehicle[invModel]</h2></a>";
...
function vehicleDetailPage($vehicle) {
    ...
    $dv .= "<img class='carDetailImage' src='$vehicle[invImage]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'>";
    $dv .= "<p><b>Description: </b>$vehicle[invDescription]</p>";
    $dv .= '<hr>';
    $dv .= "<p><b>Color: </b>$vehicle[invColor]</p>";
    $dv .= '<hr>';
    $dv .= "<p><b>Quantity in Stock: </b>$vehicle[invStock]</p>";
    $dv .= '<hr>';
    $dv .= "<p><b>Retail: $</b>$money</p>";
    return $dv;
 }
